...
plot <- plot + geom_ribbon(aes(ymin = low_7_i, ymax = upr_7_i), fill = "#CB181D", alpha = 0.3)  #state-space model with normalization
...
plot <- plot + geom_line(aes(y = med_7_i), color = "#CB181D", size = 1) 
