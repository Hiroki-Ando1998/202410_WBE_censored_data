...
write.csv(x = data_concentration, file = "/home/u31/hirokiando/20250303_RSV_FL.csv")


data_ef <- data.frame(mcmc_sample["mu"])
#write.csv(x = data_ef, file = "/home/u31/hirokiando/20250303_mcmc_RSV_FL.csv")
...
write.csv(x = data_eff_fig, file = "/home/u31/hirokiando/20250303_RSV_FL_Re.csv")
...
write.csv(x = data_fig_logis, file = "/home/u31/hirokiando/20250303_RSV_FL_logistic.csv")
