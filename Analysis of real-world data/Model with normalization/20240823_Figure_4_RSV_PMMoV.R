...
data <- data_CA
data_RSV <- data %>% select(collection_date, Count_RSV, Positive_RSV, Concentration_RSV, Concentration_sub_RSV, Concentration_PMMoV)
colnames(data_RSV) <- c("date", "count", "positive", "concentration", "substitution", "PMMoV")
...
PMMoV_ave <- mean(data_RSV$PMMoV, na.rm = TRUE)
...
data_concentration <- cbind(data_RSV, result_7_a, result_7_ind)

write.csv(x = data_concentration, file = "/home/u31/hirokiando/20250226_RSV_CA.csv")


data_ef <- data.frame(mcmc_sample["mu"])
#write.csv(x = data_ef, file = "/home/u31/hirokiando/20250226_mcmc_RSV_CA.csv")
...
write.csv(x = data_eff_fig, file = "/home/u31/hirokiando/20250226_RSV_CA_Re.csv")
...
write.csv(x = data_fig_logis, file = "/home/u31/hirokiando/20250226_RSV_CA_logistic.csv")
